...
corrigir_taxonomia_deprecated <- function(myData) {
  ...
  myData <- myData %>%
    ...
    mutate(
      classe = case_when(
        ...
        classe == "Aves" & taxon_validado == "Alouatta puruensis" ~ "Mammalia",
        TRUE ~ classe)) %>%
    # ordem
    mutate(
      ordem = case_when(
        ...
        ordem == "Artiodactyla" & taxon_validado == "Alouatta puruensis" ~ "Primates",
        ordem == "Rodentia" & taxon_validado == "Alouatta puruensis" ~ "Primates",
        ordem == "Galliformes" & taxon_validado == "Alouatta puruensis" ~ "Primates",
    ...
    mutate(
      familia = case_when(
        familia == "Callitrichidae" & taxon_validado == "Saguinus niger" ~ "Cebidae",
        familia == "Callitrichidae" & taxon_validado == "Saguinus sp" ~ "Cebidae",
        familia == "Callitrichidae" & taxon_validado == "Saguinus weddelli" ~ "Cebidae",
        familia == "Cervidae" & taxon_validado == "Alouatta puruensis" ~ "Atelidae",
        familia == "cracidae" ~ "Cracidae",
        familia == "Cracidae" & taxon_validado == "Alouatta puruensis" ~ "Atelidae",
        familia == "Dasyproctidae" & taxon_validado == "Alouatta puruensis" ~ "Atelidae",
        is.na(familia) & taxon_validado == "Cracidae" ~ "Cracidae",
        is.na(familia) & taxon_validado == "Tinamidae" ~ "Tinamidae",
        familia == "Sciuridae" & taxon_validado == "Alouatta puruensis" ~ "Atelidae",
        ...
        familia == "Myrmecophagidae" & genero == "Cyclopes" ~ "Cyclopedidae",
    ...
    mutate(
      genero = case_when(
        genero == "Ateles" & taxon_validado == "Alouatta puruensis" ~ "Alouatta",
        genero == "Callicebus" & taxon_validado == "Plecturocebus toppini" ~ "Plecturocebus",
        genero == "Callithrix" & taxon_validado == "Mico humeralifer" ~ "Mico",
        genero == "Cebus" & taxon_validado == "Sapajus apella" ~ "Sapajus",
        genero == "Cebuella" & taxon_validado == "Mico melanurus" ~ "Mico",
        genero == "Crax" & taxon_validado == "Pauxi tuberosa" ~ "Pauxi",
        genero == "Colinus" & taxon_validado == "Odontophorus gujanensis" ~ "Odontophorus",
        genero == "Crypturellus" & taxon_validado == "Tinamus sp" ~ "Tinamus",
        is.na(genero) & taxon_validado == "Odontophorus gujanensis" ~ "Odontophorus",
        genero == "Dasyprocta" & taxon_validado == "Alouatta puruensis" ~ "Alouatta",
        genero == "Dasyprocta" & taxon_validado == "Penelope superciliaris" ~ "Penelope",
        genero == "Galea" & taxon_validado == "Dasyprocta fuliginosa" ~ "Dasyprocta",
        ...
        genero == "Lycalopex" & taxon_validado == "Cerdocyon thous" ~ "Cerdocyon",
        genero == "Mazama" & taxon_validado == "Alouatta puruensis" ~ "Alouatta",
        genero == "Mico" & taxon_validado == "Saguinus niger" ~ "Saguinus",
        genero == "Mico" & taxon_validado == "Saguinus sp" ~ "Saguinus",
        genero == "Mico" & taxon_validado == "Saguinus weddelli" ~ "Saguinus",
        ...
        genero == "Myoprocta" & taxon_validado == "Dasyprocta croconota" ~ "Dasyprocta",
        genero == "Myoprocta" & taxon_validado == "Dasyprocta leporina" ~ "Dasyprocta",
        genero == "Myoprocta" & taxon_validado == "Dasyprocta sp" ~ "Dasyprocta",
        genero == "Penelope" & taxon_validado == "Alouatta puruensis" ~ "Alouatta",
        genero == "Saguinus" & taxon_validado == "Mico melanurus" ~ "Mico",
        genero == "Saguinus" & taxon_validado == "Mico sp" ~ "Mico",
        genero == "Sapajus" & taxon_validado == "Saimiri collinsi" ~ "Saimiri",
        genero == "Sciurillus" & taxon_validado == "Alouatta puruensis" ~ "Alouatta",
    ...
    mutate(
      taxon_validado = case_when(
        ...
        taxon_validado == "MAZAMA" ~ "Mazama sp",
        ...
        taxon_validado == "Dasyprocta Leporina" ~ "Dasyprocta leporina",
